                    ...
                    <div className="card w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-50 text-gray-800">
                            ...
                            <div className="my-6 space-y-4">
                                ...
                                <button aria-label="Login with GitHub" onClick={handleGithubLogin} className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-600 focus:ring-lime-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                            ...
                            <form onSubmit={handleLogin} className="space-y-8">
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <input type="email" name="email" id="email" placeholder="jondoe@gmail.com" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-lime-600" />
                                    </div>
                                    <div className="space-y-2">
