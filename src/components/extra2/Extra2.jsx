...
const Extra2 = () => {
    return (
        <div>
            <div className="mb-16">
                <div className="bg-gradient-to-r py-16 px-6 relative">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <div
                            className="max-w-2xl left-0 right-0  mx-auto w-full bg-white p-5 flex items-center shadow-lg absolute -bottom-12 rounded-md">
